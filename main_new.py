...
with col1:
    ...
    <div class="stat-box">
        ...
        <div class="stat-label">Real-Time Analytics & Insights</div>
    </div>
    """, unsafe_allow_html=True)
...
with col2:
    ...
    <div class="stat-box">
        <div class="stat-number">🎯</div>
        <div class="stat-label">Advanced Recovery Tracking</div>
    </div>
    """, unsafe_allow_html=True)
...
with col3:
    ...
    <div class="stat-box">
        <div class="stat-number">💪</div>
        <div class="stat-label">Comprehensive Health Metrics</div>
    </div>
    """, unsafe_allow_html=True)

# Highlights section
st.markdown('<div class="section-title">✨ What Makes FitSync Special</div>', unsafe_allow_html=True)
...
with col1:
    ...
    <div class="highlight-item">
        ...
        <div class="highlight-text">Advanced Data Visualization</div>
    </div>
    """, unsafe_allow_html=True)
...
with col2:
    ...
    <div class="highlight-item">
        <div class="highlight-number">🎨</div>
        <div class="highlight-text">Beautiful Light & Dark Themes</div>
    </div>
    """, unsafe_allow_html=True)
...
with col3:
    ...
    <div class="highlight-item">
        <div class="highlight-number">🚀</div>
        <div class="highlight-text">Lightning-Fast Performance</div>
    </div>
    """, unsafe_allow_html=True)
